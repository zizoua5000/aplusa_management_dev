...
class Device(models.Model):
    ...
    manufacturer = models.ForeignKey(Company, models.DO_NOTHING,related_name='manufacturer', blank=True, null=False)
    ...
    device_location = models.ForeignKey(DeviceLocation, models.DO_NOTHING, blank=True, null=False)
    ...
    sell_count = models.BigIntegerField(blank=True, null=False)
